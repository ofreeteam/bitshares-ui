...
const CORE_ASSET = "NBS"; // Setting this to NBS to prevent loading issues when used with NBS chain which is the most usual case currently
...
class SettingsStore {
    ...
    init() {
        return new Promise(resolve => {
            ...
            let topMarkets = {
                markets_cd931cb9: getMyMarketsQuotes(),
                markets_905413ea: [
                    // TESTNET
                    "NBS",
                    "CNY"
            ...
            let bases = {
                markets_cd931cb9: getMyMarketsBases(),
                markets_905413ea: [
                    // TESTNET
                    "NBS"
                ]
            ...
            let coreAssets = {
                markets_cd931cb9: "NBS",
                markets_905413ea: "NBS" //  TESTNET
            };
            let coreAsset = coreAssets[this.starredKey] || "NBS";
            /*
            ...
            let defaultBases = bases[this.starredKey] || bases.markets_cd931cb9;
    ...
    _getChainId() {
        return (Apis.instance().chain_id || "cd931cb9").substr(0, 8);
    }
