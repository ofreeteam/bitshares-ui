...
tarif etmektedir. Fakat fiilen bir  ekosisteme dönüşmesi  NewBitShares gibi 
gerçek bir blokzinciri ile birlikte mümkün olur.

NewBitShares , blokzinciri yeniliğini , hizmetlerini internet kullanarak sunan tüm 
...
Bitcoin para için ne yaptıysa NewBitShares'de işletmeler için onu yapar. Bunu , evrensel, 
şeffaf, güvenilir, verimli ve karlı şirketler yaratmak için dağıtık mutabakat teknolojisini 
kullanarak yapar.

## Bu Cüzdan

Şu an bu tarayıcı penceresinde açık olan cüzdanla NewBitShares ağının tüm işlevlerine
erişebilirsiniz.
