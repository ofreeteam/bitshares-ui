...
can be achieved by NewBitShares' market pegged assets (MPA), a new type of freely
...
more of its value backed by the NewBitShares core currency (NBS), to which they can
